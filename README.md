...
[![Hugo v0.162.1](https://img.shields.io/badge/hugo-0.162.1-ff4088?logo=hugo&logoColor=white)](https://github.com/gohugoio/hugo)
...
My IT Personal Blog built with [GoHugo](https://gohugo.io/) `v0.162.1` using a modified version of the [Color Your World](https://themes.gohugo.io/hugo-theme-color-your-world/) theme.
...
`.\build-cf.ps1 -HugoVersion 0.162.1`
